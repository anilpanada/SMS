...
.controller('testCtrl', function($scope, $rootScope, $state, $ionicModal, Data, ApiService) {
	...
	$scope.writetest = function(){
		if($rootScope.isOnline){
            ...
            localStorage.setItem('sms_sync_get_daily_test_review&user_id='+$rootScope.loggedInUserInfo.id+'&test_id='+$scope.pageInfo.writetest.test_id+'&answer_id='+$scope.newansid, JSON.stringify({data: {data:reviewData, status: 'Success'}}));


            var ress = JSON.parse(localStorage.getItem('sms_sync_get_daily_tests&user_id='+$rootScope.loggedInUserInfo.id));
            ...
            localStorage.setItem('sms_sync_get_daily_tests&user_id='+$rootScope.loggedInUserInfo.id, JSON.stringify(ress));


            var reportData = JSON.parse(localStorage.getItem('sms_sync_get_daily_test_report&user_id='+$rootScope.loggedInUserInfo.id+'&test_id='+$scope.pageInfo.writetest.test_id));
            ...
            localStorage.setItem('sms_sync_get_daily_test_report&user_id='+$rootScope.loggedInUserInfo.id+'&test_id='+$scope.pageInfo.writetest.test_id, JSON.stringify(reportData));
            $scope.pageInfo.template = 'review';
